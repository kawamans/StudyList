...
<%
    ...
    Function<HttpServletRequest, Object[]> rmdGetResponseInfo = (rmdRequest) -> {
        ...
        if (Objects.nonNull(rb)) {
            requestStatus = rb.getRequestStatus();
            message = rb.getMessage();
            EmployeeBean emp = rb.getEmployeeBeanList().stream().findFirst().orElse(null);
...
<body>
    ...
    <div class="div-login-form">
        ...
        <!-- 1. labelタグを作成し、エラー（message）を表示させて下さい-->
        <!-- 2. labelタグに適切なクラス属性を付けて下さい-->
        <!-- Tips: common.cssより、赤色の文字色を定義しているスタイルを確認 -->
        <!-- ここに記述 -->
        ...
        %>
        <!-- FIXME Step-1-3: actionに送信先URLを記述しなさい。 -->

...
public final class ConstSQL {
    ...
    public static final String JDBC_CONNECTION = "jdbc:postgresql://localhost:XXXX/lesson_db2?useUnicode=true&characterEncoding=utf8";
    /** ユーザー名 */
    ...
    public static final String SELECT_BASE = "ここに記述";
    /** 社員情報一覧取得用クエリ: 削除されていない社員情報をID番号順に取得 */
